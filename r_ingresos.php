    ...
    <script>
			$(document).ready(function(){
				...
				$('#link1').click(function(){
					...
					link1.setAttribute("href", "detalle_ingresos.php?f1="+desde+"&f2="+hasta);
				});
			});
			function link()
			{
				...
				a.setAttribute("href", "exportar_ingresos.php?f1="+desde+"&f2="+hasta);
				buscar();
			}
    ...
    <!-- Wrapper -->
			<div id="wrapper">
				...
				<div id="main">
					...
					<h3 style="margin-left:40%;">Reporte Ingresos</h3>
					<div class="box">
						<div class="row uniform">
							...
							<div class="3u 12u(xsmall)"><!--reportes.-->
									<a style='text-decoration:none;' href='' id='link'><img src='images/descarga.png' width='46' height='46' border='0' title='Exportar'></a>
							</div>
							<div class="3u 12u(xsmall)"><!--reportes.-->
									<a id="link1" style="cursor:pointer;">Detalles Ingresos</a>
							</div>
						</div>
              			<br>
						<div class="box">
