...
if($_POST['guardar']=="Guardar")//if guardar
{
	...
	if($_POST['total']!=0)//if total
	{
		...
		*/
		...
		$insertgastos="INSERT INTO gastos (id_usuario,factura,proveedor,concepto,subtotal,id_tipo_impuesto,iva,ish,retencion_isr,total,tipo_gasto,tipo_subgasto,deducible,id_proyecto,fecha,id_area,metodo_pago,presupuestado,fecha_presupuestado) values ('$idU','$nof','$idprov','$concepto','$subtotal',0,'0','0','0','$total','$idgasto','$idsubgasto','No','$proyecto','$fechad','$area','$mpago','$pres','$fechab')";
...
$(document).ready(function(){
		...
		$(".iframe3").colorbox({iframe:true,width:"90%", height:"600",transition:"fade", scrolling:true, opacity:0.1});
	...
	{
	//alert(val);
	$(".iframe3").colorbox({iframe:true,width:"90%", height:"600",transition:"fade", scrolling:true, opacity:0.1,href: "modificar_gastos.php?idup="+val+"&idu="+<? echo $idU;?>});
	// Resize ColorBox when resizing window or changing mobile device orientation
	//jQuery(window).resize(resizeColorBox);
	/*window.addEventListener("orientationchange", resizeColorBox, false);*/
				...
				<!-- Header -->
					...
					<nav id="navegador" >
						<ul class="links">
							...
							<li><a href="presupuestados.php">Presupuestar Gasto</a></li>
						</ul>
					</nav>
					</div>
				<!--===========================================================================-->
				...
				<div id="main">
					<form name="enviargasto" id="enviargasto" method="post">
						...
						<div class="row uniform" id="info">
								...
								<div class="4u 12u(xsmall)"><!--Tipo de Subgasto.-->
									<label for="gasto">Tipo de Subgasto</label>
									<input class="upper" list="subgasto" name="subgasto" type="text" required>
								...
								<div class="4u 12u(xsmall)"><!--Metodo de Pago.-->
									<label for="mpago">M�todo de Pago</label>
								...
								<div class="4u 12u(xsmall)"><!--No.Factura.-->
								...
								<div class="4u 12u(xsmall)"><!--Tipo.-->
									<label for="tipo">T�po de Impuesto(<i class="fa fa-plus" onClick="agregar_imp()"></i>)</label>
