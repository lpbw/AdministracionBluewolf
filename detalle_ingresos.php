  ...
  <head>
    ...
    <script>
			...
			function link()
			{
				...
				a.setAttribute("href", "exportar_detalleingresos.php?f1="+desde+"&f2="+hasta);
			}
			...
			   }
					...
					xmlhttp.open("GET","buscar_detalle.php?desde="+desde+"&hasta="+hasta+"&val="+val,true);
					xmlhttp.send();
			}
    </script>
  </head>
				...
				<div id="main">
					...
					<div class="box">
						<div class="row uniform">
							<div class="3u 12u(xsmall)"><!--reportes.-->
									<label for='desde'>Desde</label><input class='datepicker' name='desde' id='desde' value='<?echo $desde?>' onchange='link()'/>
							</div>
							<div class="3u 12u(xsmall)"><!--reportes.-->
									<label for='hasta'>Hasta</label><input class='datepicker' name='hasta' id='hasta' value='<?echo $hasta?>' onChange='link()'/>
							</div>
							<div class="3u 12u(xsmall)"><!--reportes.-->
									<a style='text-decoration:none;'  id='link' onclick="link();"><img src='images/descarga.png' width='46' height='46' border='0' title='Exportar'></a>
							</div>
						</div>
              			<br>
						<div class="box">
