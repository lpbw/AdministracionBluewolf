    ...
    <script>
			$(document).ready(function(){
				...
				$('#link1').click(function(){
					...
					link1.setAttribute("href", "detalle_egresos.php?f1="+desde+"&f2="+hasta);
				});
			});
			function link()
			{
				...
				a.setAttribute("href", "exportar_egresos.php?f1="+desde+"&f2="+hasta);
				buscar();
			}
    ...
    <!-- Wrapper -->
			<div id="wrapper">
				...
				<div id="main">
					...
					<h3 style="margin-left:40%;">Reporte Egresos</h3>
					<div class="box">
						<div class="row uniform">
							...
							<div class="3u 12u(xsmall)"><!--reportes.-->
									<a id="link1" style="cursor:pointer;">Detalles Egresos</a>
							</div>
						</div>
              			<br>
						<div class="box">
